...
The contents of the metadata file is formatted as JSON that contains a single JSON object. The main purposes of the file include:\todo{should we explicitly list FROG version?}
\begin{itemize}
