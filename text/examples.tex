...
\caption[\emph{E.~coli} core gene deletion report]{First 45 lines of a FROG gene deletion report \texttt{03\_gene\_deletion.tsv} in TSV format as generated from \texttt{e\_coli\_core.xml}. The file is available online at \url{\frogrepobase/data/ecoli/03_gene_deletion.json}.}
\label{lst:ecoli-genes}
\end{sidewayslisting}

\begin{sidewayslisting}
\lstinputlisting[language=tsv,firstline=1,lastline=45]{data/ecoli/04_reaction_deletion.tsv}
\caption[\emph{E.~coli} core reaction deletion report]{First 45 lines of a FROG reaction deletion report \texttt{03\_reaction\_deletion.tsv} in TSV format as generated from \texttt{e\_coli\_core.xml}. The file is available online at \url{\frogrepobase/data/ecoli/04_reaction_deletion.json}.}
